        ...
        ViewInteraction editText2 = onView(
                allOf(withId(R.id.convert_value_gasolina),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        editText2.perform(replaceText("4.09"), closeSoftKeyboard());
        ...
        ViewInteraction editText3 = onView(
                allOf(withId(R.id.convert_value_alcool),
                        childAtPosition(
                                ...
                                3),
                        isDisplayed()));
        editText3.perform(replaceText("2.599"), closeSoftKeyboard());
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.convert_text_after_button), withText("Abasteça com Álcool"),
                        childAtPosition(
                                ...
                                5),
                        isDisplayed()));
        textView2.check(matches(withText("Abasteça com Álcool")));
        ...
        ViewInteraction textView3 = onView(
                allOf(withId(R.id.convert_text_after_button), withText("Abasteça com Álcool"),
                        childAtPosition(
                                ...
                                5),
                        isDisplayed()));
        textView3.check(matches(withText("Abasteça com Álcool")));
